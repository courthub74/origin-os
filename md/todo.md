### Things to do for this Prototype

\* ~Quick action alignments~

\* ~Finish Upload image and placement on distribution page~
...
\* Add an image 'drag/drop' input to the create an image function. to influence any prompting.

### After Image creation

\* Prompt: Do you like this image? if so: Continue | if not try: Regenerate or just: Edit Details

\* if CONTINUE clicked then user taken to a screen/modal: Save Locally-Save to Account- Both

\* then user is taken to the BRANDING page.
